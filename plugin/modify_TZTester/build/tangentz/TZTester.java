...
public class TZTester
    ...
    private void generate_test_case(int Index, StringBuffer Code, DataType[] ParamTypes, DataType ReturnType, TestCase Case)
        ...
        */
        ...
        Code.append("\n\tverify_case(" + Index + ", Arg" + Inputs.length + ", " + m_Problem.getMethodName() + "(");
    ...
    private void generate_parameter(int Index, StringBuffer Code, DataType ParamType, String Input)
        ...
        if (ParamType.getDimension() == 0)
            ...
            if (Desc.equals("long") || Desc.equals("Long"))
                Code.append("\n\t" + ParamType.getDescriptor(m_Language) + " Arg" + Index + " = " + Input + "LL; ");
            else
                Code.append("\n\t" + ParamType.getDescriptor(m_Language) + " Arg" + Index + " = " + Input + "; ");
            // end if
            }
        else
            {
            // Arrays need to be converted to vector<type> before passing
            Code.append("\n\t" + ParamType.getBaseName().toLowerCase() + " Arr" + Index + "[] = " + Input + "; ");
            Code.append("\n\t" + ParamType.getDescriptor(m_Language) + " Arg" + Index + "(Arr" + Index + ", Arr" + Index + " + (sizeof(Arr" + Index + ") / sizeof(Arr" + Index + "[0]))); ");
            }
        // end if
        }
